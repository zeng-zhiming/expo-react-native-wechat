                  ...
                  :(RCTResponseSenderBlock)callback)
{
    ...
    BOOL register1 = [WXApi registerApp:appid universalLink:universalLink];
//     NSLog(@"===>%@=====%@==%d", appid, universalLink, register1) ;

    callback(@[register1 ? [NSNull null] : INVOKE_FAILED, @(register1)]);
}
